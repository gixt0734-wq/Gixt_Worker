...
class Inforeportclientpage extends StatefulWidget {
  const Inforeportclientpage({super.key, required this.report_id});
  final String report_id;
  @override
  State<Inforeportclientpage> createState() => _InforeportclientpageState();
}

class _InforeportclientpageState extends State<Inforeportclientpage> {
  bool isLoading = false;
  bool hasMore = true;
  final ReportsServiceClient report = ReportsServiceClient();
  ...
  Widget _buildTitle() {
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          report.report[0].client_username,
          maxLines: 2,
            ...
            child: Row(
              children: [
                Circleimage(
                  w: 56,
                  h: 56,
                  image_url: report.report[0].worker_image,
                ),
