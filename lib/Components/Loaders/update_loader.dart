...
class UpdateLoader extends StatefulWidget {
  final Future<Map<String, dynamic>> Function() onRun;
  final Future<void> Function(Map<String, dynamic> result) onSuccess;

  const UpdateLoader({super.key, required this.onRun, required this.onSuccess});

  @override
  State<UpdateLoader> createState() => _UpdateLoaderState();
}

class _UpdateLoaderState extends State<UpdateLoader>
