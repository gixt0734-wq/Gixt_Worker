...
class DocumentsLoader extends StatefulWidget {
  final Future<Map<String, dynamic>> Function() onRun;
  final Future<void> Function(Map<String, dynamic> result) onSuccess;

  const DocumentsLoader({super.key, required this.onRun, required this.onSuccess});

  @override
  State<DocumentsLoader> createState() => _DocumentsLoaderState();
}

class _DocumentsLoaderState extends State<DocumentsLoader>
                ...
                AnimatedFractionallySizedBox(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(10),
                      boxShadow: [
                        BoxShadow(color: colorsecundario, blurRadius: 8),
                      ],
                    ),
                  ),
                ),
  ...
  return Padding(
    ...
    child: Column(
      ...
      children: [
        ...
        Text(
          'Documentos subidos correctamente. Estos son los siguientes pasos:',
          textAlign: TextAlign.center,
          style: GoogleFonts.poppins(
            fontSize: 13.5,
            fontWeight: FontWeight.w400,
          ...
          child: Column(
            children: [
              _itemInfo(
                ...
                'Espera la respuesta de soporte.',
              ),
              _itemInfo(
              ...
              _itemInfo(
                ...
                'Si algún paso falla, vuelve a intentarlo.',
              ),
            ],
          ),
        )
